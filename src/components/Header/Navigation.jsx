...
export default function Navigation() {
    ...
    const [showProfileItems, toggleProfileItems] = useState(false);
    ...
    const toggleProfile = () => {
        toggleProfileItems(!showProfileItems);
    }

    return (
        <nav className="flex justify-between bg-gray-800 sticky w-full z-50 top-0 dark:bg-green-700 max-w-full mx-auto p-2 sm:px-6 lg:px-8">
            <div class="">
                <img
                ...
                alt="Workflow"
                />
                <ul className="inline p-4">
                    {navigation.map(navItem => <li className="inline p-2 hover:text-white active:bg-yellow">{navItem.name}</li>)}
                </ul>
                </div>
                <div class="relative">
                    <CgProfile ref={profileRef} onClick={toggleProfile} className={`h-12 w-auto text-white`} />
