...
function AboutMePage() {
    return (
        <div className="min-w-xl max-w-4xl mx-auto px-4 overflow-y-auto dark:bg-gray-600">
            <section
                id="profile"
                className="dark:bg-gray-800 flex flex-col sm:flex sm:flex-row max-h-96 sm:p-5 sm:border-2 my-10 sm:rounded-md sm:shadow-md sm:border-gray-400 items-center">
                <img
                ...
                <article className="w-max-2xl px-8 dark:text-gray-100">
